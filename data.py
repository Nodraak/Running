...
RUNS = (
    ...
    # 12 runs - 200-210 km (TBC)
    RunShort(pd('2022-09-03'), 15, 67.90, 21),
    RunShort(pd('2022-09-05'), 15, 63.50, 15), # PB - 15k: 14.17 km/h (12k: 14.36, 21.1k: 13.88)
    RunShort(pd('2022-09-08'), 15, 66.00, 15),
    RunLong(pd('2022-09-10'), 25, 116.5, 19),
    RunShort(pd('2022-09-13'), 12, 50.85, 16),
    RunShort(pd('2022-09-16'), 15, 63.30, 10), # PB - 15k: 14.22 km/h (12k: 14.41, 21.1k: 13.93)
    RunLong(pd('2022-09-17'), 27, 122.83, 15),
    RunShort(pd('2022-09-20'), 15, 64.30, 9),
    RunShort(pd('2022-09-23'), 9, 36.63, 7), # PB - 9k: 14.75 km/h (12k: 14.49, 15k: 14.30, 21.1k: 14.01)
    RunLong(pd('2022-09-25'), 15, 64.58, 17),



    # 12 runs - 170-190 km (TBC)
